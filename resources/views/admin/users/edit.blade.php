    ...
    <form action="{{route('users.update', $user)}}" method="post">
        ...
        <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="boolean" class="form-control @error('is_admin') is-invalid @enderror" id="exampleInputIsAdmin" placeholder="Masukkan Role 1/0" name="is_admin" value="{{$user->is_admin ?? old('is_admin')}}">
